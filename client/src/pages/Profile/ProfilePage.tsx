...
const ProfilePage = () => {
	...
	const [feedType, setFeedType] = useState<string>("profilePosts");
					...
					{!isLoading && !isRefetching && user && (
						<>
							...
							<div className="relative group/cover">
								...
								{isMyProfile && (
									<div
										className="text-white absolute top-2 right-2 rounded-full p-2 bg-gray-800 bg-opacity-75 cursor-pointer opacity-0 group-hover/cover:opacity-100 transition duration-200"
							...
							<div className="flex w-full border-b border-gray-700 mt-4">
								<div
									...
									onClick={() => setFeedType("profilePosts")}
								>
									Posts
									{feedType === "posts" && (
